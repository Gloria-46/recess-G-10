...
<div class="min-h-[60vh] flex flex-col items-center justify-center py-16">
    ...
    <div class="flex flex-col md:flex-row gap-8 mt-6">
        ...
        <a href="{{ route('retailer.login') }}" class="px-10 py-6 bg-purple-700 hover:bg-purple-900 text-white text-2xl font-bold rounded-2xl shadow-lg flex flex-col items-center transition-all duration-200">
