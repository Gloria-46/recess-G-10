...
<div class="max-w-7xl mx-auto py-8 relative z-10">
    ...
    <div class="text-center mb-12 bg-gradient-to-r from-[#23235b] to-blue-900 rounded-3xl p-8 shadow-lg border border-blue-100">
        <div class="max-w-4xl mx-auto">
            <h1 class="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-yellow-300 to-yellow-400 bg-clip-text text-transparent">
            ...
            <div class="flex flex-wrap justify-center gap-4 text-sm text-yellow-200">
                <span class="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full shadow-sm">
    ...
    @if((!isset($category) || !in_array($category, ['ladies', 'gentlemen'])) && isset($previouslyOrdered) && count($previouslyOrdered) > 0)
        <div class="mb-10">
            <h2 class="text-2xl font-semibold mb-4 text-blue-900 flex items-center"><i class="fas fa-history mr-2"></i> FOR YOU</h2>
            <p class="text-blue-800 mb-6 max-w-3xl font-medium">Basing on your previous orders. Order again or explore similar items!</p>
    ...
    <h2 class="text-2xl font-bold mb-6 text-blue-900">YOU MAY ALSO LIKE</h2>
    <p class="text-blue-800 mb-6 max-w-3xl font-medium">Explore a wider variety of our apparel for an unforgettable experience. Choose Uptrend , choose quality.</p>
    <br>
