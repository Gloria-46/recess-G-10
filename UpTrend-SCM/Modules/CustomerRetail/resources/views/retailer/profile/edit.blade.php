                    ...
                    <div class="bg-white rounded-xl p-4 shadow-sm border border-green-200">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-bold text-gray-900">{{ \Modules\CustomerRetail\App\Models\Product::where('retailer_id', $retailer->id)->count() }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-4 shadow-sm border border-blue-200">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-bold text-gray-900">{{ \Modules\CustomerRetail\App\Models\Order::where('retailer_id', $retailer->id)->count() }}</p>
                            </div>
                        </div>
                    </div>
