...
@section('title', 'Products - Retailer Dashboard')
    ...
    <div id="products-animate" class="opacity-0 translate-y-8 transition-all duration-700">
        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <a href="{{ route('retailer.products.create') }}" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 font-semibold">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div class="border-2 border-dashed border-gray-300 rounded-2xl flex flex-col items-center justify-center h-80 hover:border-blue-400 hover:bg-blue-50 transition-all duration-300 group cursor-pointer">
                <div class="text-center">
                    ...
                    <a href="{{ route('retailer.products.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium">
                        <i class="fas fa-plus mr-2"></i>
                        Add Product
                    </a>
                </div>
