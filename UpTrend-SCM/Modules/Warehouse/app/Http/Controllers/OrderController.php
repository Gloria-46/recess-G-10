...
class OrderController extends Controller
{
    ...
    {
        $orders = Order::with(['orderItems', 'customerOrder', 'vendorOrder'])->latest()->paginate(10);
        $stats = [
    ...
    public function create()
    {
        ...
        return view('warehouse::warehouse.orders.create', compact('products'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!$isDraft) {
            ...
            $validationRules['items.*.product_id'] = 'required|exists:warehouse_products,product_id';
    ...
    public function show(Order $order)
    {
        ...
        return view('warehouse::warehouse.orders.show', compact('order'));
    }
    ...
    public function edit(Order $order)
    {
        ...
        return view('warehouse::warehouse.orders.edit', compact('order', 'products'));
    }
    ...
    {
        $orders = \Modules\Warehouse\App\Models\Order::orderByDesc('created_at')->get();
        return view('warehouse::warehouse.orders.retailers', compact('orders'));
    }

    public function myRetailerOrders()
    {
        $orders = \Modules\Warehouse\App\Models\Order::where('staff_id', auth()->id())->orderByDesc('created_at')->get();
        return view('warehouse::warehouse.orders.my_retailer_orders', compact('orders'));
    }
}
