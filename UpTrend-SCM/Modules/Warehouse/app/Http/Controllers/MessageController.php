...
use Modules\Warehouse\App\Events\MessageSent;
use Modules\Warehouse\App\Events\MessageRead;
use App\Models\User;
use App\Services\ChatUserService;
use Modules\Warehouse\App\Models\Conversation;
...
class MessageController extends Controller
{
    public function index()
    {
        ...
        return view('warehouse::chat.index', compact('groups'));
    }
    /**
...
// }
    ...
    // Find existing conversation or create a new one
        ...
        return view('warehouse::chat.conversation', [
            'user' => $user,
            'messages' => $messages,
            'conversation' => $conversation,
        ]);
