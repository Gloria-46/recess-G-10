...
<head>
    ...
    <title>Chat - UpTrend Vendor</title>
...
<body class="bg-gray-50 overflow-x-hidden">
    ...
    <nav class="flex items-center justify-between px-6 py-4 bg-indigo-950 text-white shadow-sm border-b">
        <div class="flex items-center gap-6 text-white">
            ...
            <ul class="flex gap-8">
                <li>
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2 text-white font-medium text-blue-400 border-b-2 border-blue-400 pb-1">
                        <i class="fas fa-chart-line"></i> DASHBOARD
                    </a>
                </li>
                <li>
                    <a href="{{ route('suppliers.index') }}" class="flex items-center gap-2 text-white hover:text-blue-400 transition-colors">
                        <i class="fas fa-truck"></i> SUPPLIERS
                    </a>
                </li>
                <li>
                    <a href="{{ route('orders.index') }}" class="flex items-center gap-2 text-white hover:text-blue-400 transition-colors">
                        <i class="fas fa-shopping-cart"></i> ORDERS
                    </a>
                </li>
                <li>
                    <a href="{{ route('materials.index') }}" class="flex items-center gap-2 text-white hover:text-blue-400 transition-colors">
                        <i class="fas fa-boxes"></i> MATERIALS
                    </a>
                </li>
                <li>
                    <a href="{{ route('performance.index') }}" class="flex items-center gap-2 text-white hover:text-blue-400 transition-colors">
        ...
        <div class="flex items-center gap-4">
            <div x-data="{ open: false }" class="relative text-sm text-white cursor-pointer select-none">
                <div @click="open = !open" class="flex items-center">
                    <a href="{{ route('vendor.chat.index') }}" class="flex items-center">
            ...
            <div class="chat-header mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-blue-100">Connect with your team members and customers</p>
                    </div>
                ...
                @if($users->count())
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                        @foreach($users as $userItem)
                            <a href="{{ route('vendor.chat.with', $userItem->id) }}" class="block">
                                <div class="user-card p-4" style="overflow: hidden">
                                    <div class="flex items-center gap-4">
                                        <div class="relative">
