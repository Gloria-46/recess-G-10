...
<div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0"
            ...
            <span class="font-weight-bold text-lg">UpTrend</span>
        </a>
    </div>
    <div style = "height: 100vh" class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('admin.dashboard') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('staff.index') ? 'active' : '' }}" href="{{ route('staff.index') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <g id="table" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="view-grid" transform="translate(12.000000, 12.000000)" fill="#FFFFFF"
                                    fill-rule="nonzero">                                        <path class="color-foreground"
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('stages.index') ? 'active' : '' }}" href="{{ route('stages.index') }}">
                    <div
                    class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">Work Allocation</span>
                </a>
            </li>
            {{-- <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('admin.allowed_emails.index') ? 'active' : '' }}" href="{{ route('admin.allowed_emails.index') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>allowed_emails</title>
