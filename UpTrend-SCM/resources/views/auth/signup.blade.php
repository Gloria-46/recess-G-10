                        ...
                        <div class="col-md-6">
                            <div class="position-absolute w-40 top-0 start-0 h-100 d-md-block d-none">
                                <div class="oblique-image position-absolute d-flex fixed-top ms-auto h-100 z-index-0 bg-cover me-n8"
                                    style="background-image:url('../assets/img/clothes-store-again.jpg')">
                                    <div class="my-auto text-start max-width-350 ms-7">
                                        <h1 class="mt-3 text-white font-weight-bolder">Join the UpTrend<br> Community.</h1>
                                        <p class="text-white text-lg mt-4 mb-4">Sign up to gain access. <br>Welcome!</p>
                                    </div>
                            ...
                            <div class="card card-plain mt-8">
                                ...
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    ...
                                    <div class="text-center mt-3">
                                        <a href="/retailer/register" class="text-dark font-weight-bold">Are you a retailer? Sign up here</a>
                                    </div>
                                </div>
                            </div>
                        </div>
