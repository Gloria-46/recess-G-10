...
style="width: 20%">
    ...
    <div style = "height: 100vh" class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link"
                {{-- {{ is_current_route('admin.dashboard') ? 'active' : '' }} --}}
            ...
            <li class="nav-item">
                <a class="nav-link
                  {{-- {{ is_current_route('staff.index') ? 'active' : '' }} --}}
            ...
            <li class="nav-item">
                <a class="nav-link  
                {{-- {{ is_current_route('stages.index') ? 'active' : '' }} --}}
            ...
            <li class="nav-item">
                <a class="nav-link  
                {{-- {{ is_current_route('admin.allowed_emails.index') ? 'active' : '' }} --}}
                 " href="{{ route('admin.allowed_emails.index') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item border-start my-0 pt-2">
                ...
                {{-- {{ is_current_route('profile') ? 'active' : '' }} --}}
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 
                {{-- {{ is_current_route('signin') ? 'active' : '' }} --}}
                    " href="{{ route('signin') }}">
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 
                {{-- {{ is_current_route('signup') ? 'active' : '' }} --}}
                    " href="{{ route('signup') }}">
